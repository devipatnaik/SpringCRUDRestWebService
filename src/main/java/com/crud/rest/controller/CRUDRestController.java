...
@RestController       				// combination @Controller and @ResponseBody annotation.
public class CRUDRestController {
	...
	public void setCustomerService(CustomerService customerService){
		...
		public ResponseEntity<MyCustomer> updateCustomer(@PathVariable("id") long id,@RequestBody MyCustomer cus){
			MyCustomer customer = customerService.findById(id);
			if(customer == null){
				return new ResponseEntity<MyCustomer>(HttpStatus.NOT_FOUND);
			}
